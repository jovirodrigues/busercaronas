"""
Django settings for busercaronas project.
...
ROOT_URLCONF = 'busercaronas.urls'
...
WSGI_APPLICATION = 'busercaronas.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './busercaronas.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
